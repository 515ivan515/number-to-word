...
if lower_to_from == "from":
    ...
    for elem in all:
      if elem in words:
        print(elem)
elif lower_to_from == "to":
    intab = "abcdefghijuvwxyz015.klmnopqrst"
    outtab = "012345678901234567890123456789"
    str = raw_input("Whats Your Code?: ")
    trantab = maketrans(intab, outtab)
    uncoded = str.translate(trantab)
    print uncoded
else:
